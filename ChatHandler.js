...
const chat_names = ["Saksham Bhayana", "Ritik Aggarwal", "Sanchit Mehta", "Aman Garg", "Shikhar Gupta", "Shreya", "Abhinay"];
const chat_names_length = chat_names.length;
const chat_msg = ["I would love to do that!",
                  "Hey!!! how you doin...",
                   "Okay so let me know the tentative dates ",
                   "Yes, I will be comming tomorrow ",
                    "Hope you understand :)"
                 ];
